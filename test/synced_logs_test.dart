...
import 'package:synced_logs/service/local_logs_service.dart';
...
void main() {
  ...
  test('logLocalSaving', () async {
    ...
    for (int i = 0; i < 50; i++) {
      await LocalLogsService.saveLogLocally(new SyncedLog(tag: "LOG_TAG", otherInfo: "OTHER_LOG_INFO " + i.toString()));
    }
